...
interface PodiumJobSearchProps {
  onInterviewStart?: (data: InterviewData, setup: {
    company: string;
    position: string;
    experience: string;
...
const PodiumJobSearch: React.FC<PodiumJobSearchProps> = ({ onInterviewStart }) => {
  ...
  const finalQuestionCount = showCustomQuestionCount ? validateQuestionCount(customQuestionCount) : selectedQuestionCount;
  ...
  const handleCustomQuestionCountChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="mx-auto  bg-gray-800 rounded-2xl p-8 border border-gray-600 shadow-2xl w-full">
        ...
        <div className="text-center mb-16 mt-14">
          ...
          <p className="text-xl text-gray-300">Practice with AI-powered mock interviews tailored to your dream career!</p>
        </div>
        ...
        <div className="flex flex-col mb-8 w-full">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col md:grid grid-cols-4 lg:grid-cols-6 gap-3  w-full">
              ...
              >
                <div className={`bg-gray-600 p-3 rounded-xl shadow-lg border-2 h-20 w-full flex flex-col justify-center ${
              ...
              {filteredCompanies.map((company) => (
                <div
                  ...
                  className="relative cursor-pointer transition-all duration-300 transform hover:scale-105"
                >
                  <div className={`${company.color} p-3 rounded-xl shadow-lg border-2 h-20 w-full flex flex-col justify-center ${
            ...
            <div className="flex flex-col md:grid grid-cols-4 lg:grid-cols-6 gap-3 w-full">
              ...
              {filteredPositions.map((position) => (
                <div
                  ...
                  className="relative cursor-pointer transition-all duration-300 transform hover:scale-105"
                >
                  <div className={`${position.color} p-3 rounded-xl shadow-lg border-2 h-20 w-full flex flex-col justify-center ${
                    selectedPosition === position.name ? 'border-white' : 'border-transparent'
                  }`}>
                    <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col md:grid grid-cols-4 lg:grid-cols-6 gap-3 w-full">
              ...
              {filteredLevels.map((level) => (
                <div
                  ...
                  className="relative cursor-pointer transition-all duration-300 transform hover:scale-105"
                >
                  <div className={`${level.color} p-3 rounded-xl shadow-lg border-2 h-20 w-full flex flex-col justify-center ${
                    selectedLevel === level.name ? 'border-white' : 'border-transparent'
                  }`}>
                    <div className="flex flex-col items-center text-center">
        ...
        <div className="flex flex-col mb-8">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col md:grid grid-cols-4 gap-3 w-full">
              ...
              >
                <div className={`bg-gray-600 p-3 rounded-xl shadow-lg border-2 h-20 w-full flex flex-col justify-center ${
                  showCustomQuestionCount ? 'border-white' : 'border-transparent'
                }`}>
                  <div className="flex flex-col items-center text-center">
                    <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center mb-1 text-white font-bold text-sm">
                      <Plus className="w-4 h-4" />
          ...
          <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-2xl w-full md:w-3/4 lg:w-2/3 xl:w-1/2">
            {finalCompany && finalPosition && finalLevel && finalQuestionCount && (
              <div className="mb-6 p-4 bg-gray-700 rounded-lg">
                ...
                <p className="text-purple-300 text-sm mt-1">{finalQuestionCount} questions</p>
              </div>
            )}
            ...
            {(!finalCompany || !finalPosition || !finalLevel || !finalQuestionCount) && !isSubmitting && (
              <p className="text-gray-400 text-sm mt-4 text-center">
                Please select company, position, experience level, and number of questions (1-8)
              </p>
            )}
          </div>
        </div>
